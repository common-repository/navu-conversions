...
/*
    ...
    along with Contact Form to Database Extension.na
    If not, see http://www.gnu.org/licenses/gpl-3.0.html
*/

include_once('NavuConversions_OptionsManager.php');

class NavuConversions_InstallIndicator extends NavuConversions_OptionsManager {
